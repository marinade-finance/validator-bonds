...
use crate::handlers::{
    bonds, docs, protected_events, psr_protected_validators, verified_validators,
};
...
pub fn public_data_routes(context: WrappedContext) -> Router {
    ...
    Router::new()
        ...
        .route(
            "/bonds/bidding/auction",
            get(bonds::handler_bidding_auction),
        )
        ...
        .route(
            "/validators/psr-protected",
            get(psr_protected_validators::handler),
        )
        .with_state(context)
}
