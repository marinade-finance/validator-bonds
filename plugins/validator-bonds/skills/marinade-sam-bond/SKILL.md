...
| BondRiskFee           | `BondRiskFee`             | `calcBondRiskFee` in ds-sam (`bondRiskFeeSol = bondRiskFeeMult * exposedStake * feeCoef`) | ValidatorBond                              | Stakers                       | `.refs/ds-sam/…/calculations.ts` + `sam_penalties.rs`          |
