...
describe('evaluateDeltas', () => {
  ...
  it('emits bond_underfunded_change when epochs change', () => {
    ...
    const underfundedDetails =
      underfunded!.data.details as BondUnderfundedChangeDetails
    ...
    expect(underfundedDetails.epoch_cost_sol).toBeCloseTo(
      (3.2 / 1000) * 50000,
    ) // 160 SOL
  ...
  it('emits bond_balance_change when funded amount changes', () => {
    ...
    const balanceDetails =
      balanceChange!.data.details as BondBalanceChangeDetails
