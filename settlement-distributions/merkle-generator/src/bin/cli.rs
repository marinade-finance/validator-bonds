...
use clap::Parser;
use log::info;
use merkle_generator::{generate_unified_merkle_trees, load_settlement_files, GeneratorConfig};
...
fn main() -> anyhow::Result<()> {
    ...
    // Generate unified merkle trees
    let merkle_tree_collection = generate_unified_merkle_trees(sources, &config)?;
