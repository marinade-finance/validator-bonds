...
//!
//! Scraped per the deployment's `prometheus.io/scrape` + `prometheus.io/port:
//! "9000"` annotations (path `/metrics`). Mirrors the waypoint convention
//! (public API port + a separate internal metrics/health port).
