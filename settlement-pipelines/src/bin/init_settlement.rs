...
struct Args {
    ...
    /// Merkle tree collection file path generated by bid-psr-distribution as of --output-merkle-tree-collection
    #[arg(short = 'm', long)]
    input_merkle_tree_collection: PathBuf,

    /// Settlement collection file path generated by bid-psr-distribution as of --output-settlement-collection
    #[arg(short = 's', long)]
...
async fn real_main(
    ...
    let mut json_data = load_json(&[
        ...
        args.input_settlement_collection.clone(),
    ])?;
    if json_data
        .iter()
